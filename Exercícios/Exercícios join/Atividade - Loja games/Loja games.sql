...
-- lista de afazeres usando inner join -- 
-- join de produtos com categorias
-- join de produtos com usuários
-- join duplo, juntando as três tabelas em uma consulta

-- inner join de produtos com categorias
select * from tb_produtos inner join tb_categorias
-- juntando a tabela de produtos com a categoria
on tb_categorias.id = tb_produtos.categoria_id;
-- checando chave primária de categorias com a chave estrangeira de produtos

-- inner join produtos com usuários
select * from tb_produtos inner join tb_usuarios
-- juntando a tabela de produtos com a usuários
on tb_usuarios.id = tb_produtos.usuario_id;
-- checando chave primária de categorias com a chave estrangeira de produtos

-- inner join duplo
select * from tb_produtos
-- tb_produtos possui as chaves estrangeiras, por isso, puxaremos o from dela
inner join tb_categorias on tb_categorias.id = tb_produtos.categoria_id
-- primeiro, passa a chave estrangeira e depois a primária
-- inner join (chave primária) on (chave primária _ id) = (chave secundária . chave primária _ id)
